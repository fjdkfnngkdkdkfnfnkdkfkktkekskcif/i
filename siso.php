...
<br>   
<center><p>≡ Smahy <span></span></p></center>
<br>
...
echo "<div class='success'><center>
<font color='Orange '><hr>$cc<hr></font></center></div>";
}
		...
		<div class="container p-5 ">
			<form action="" method="get">
				...
				<div class="mb-3">
					...
					<div  class="form-text">ايـدي حسابك    </div>
	...
	<section>
		<div class="container p-2 text-center">
			...
			<button onclick="location.href='https://www.instagram.com/cf_17'" class="btn btn-primary   certain   icon-btn"><i class="fa fa-instagram"></i></button>
